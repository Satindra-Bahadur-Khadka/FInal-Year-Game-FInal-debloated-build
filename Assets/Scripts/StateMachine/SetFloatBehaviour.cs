...
public class SetFloatBehaviour : StateMachineBehaviour
{
    ...
    // OnStateMachineEnter is called when the state machine starts evaluating this state
    ...
    // OnStateMachineExit is called when the state machine finishes evaluating this state
